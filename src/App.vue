...
<template>
  ...
  <div class="relative">
    <img :src="yellowFlowerImg" aria-hidden="true"
      class="absolute -top-75 left-2 sm:left-6 w-64 sm:w-80 z-0 pointer-events-none select-none" />
    <img :src="pinkFlowerImg" aria-hidden="true"
      class="absolute -top-78 right-2 sm:right-6 w-56 sm:w-80 z-0 pointer-events-none select-none" />
    <WaveEdge class="relative z-10" color="var(--color-primary)" position="top" :size="60" />
